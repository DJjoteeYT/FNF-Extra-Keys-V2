		...
		switch(character)
		{
			...
			default: 
				for (i in StoryMenuState.StoryData.menuCharacters) //mostly copied from character.hx
				{
					if (i.name == character)
					{
						var imagePath = SUtil.getPath() + "assets/images/storymenu/characters/" + i.fileName + ".png";
						...
						var xmlPath = SUtil.getPath() + "assets/images/storymenu/characters/" + i.fileName + ".xml";
						var xml:String;
