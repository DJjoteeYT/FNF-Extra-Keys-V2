...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if sys
		trace("ZOROENGINELOG: " + "getting content from: " + Main.getStoragePath() + Paths.imageJson("storymenu/menu"));
		var rawJson = File.getContent(Main.getStoragePath() + Paths.imageJson("storymenu/menu"));
		#else
		...
		sprDifficulty = new FlxSprite(leftArrow.x + 130, leftArrow.y).loadGraphic(BitmapData.fromFile(Main.getStoragePath() + diffPath));
